...
slack = read_file("slack-pivot-from-glitch-2013.md")
slack_nodes_start = slack.find("nodes:\n")
slack_nodes_end = slack.find("---", slack_nodes_start)
new_slack_nodes = """nodes:
  start:
    dimension: founder
    prompt: |
...
\n"""
write_file("slack-pivot-from-glitch-2013.md", slack[:slack_nodes_start] + new_slack_nodes + slack[slack_nodes_end:])
