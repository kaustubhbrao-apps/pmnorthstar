...
export const caseStudiesLite: CaseStudyLite[] = [
  ...
  },
  {
    id: "cs-146",
    company: "Vanta",
    title: "Vanta: Inventing the Continuous Compliance Category",
    category: "Strategy",
    description: "How Vanta turned SOC 2 compliance—the most boring, painful, and manual process in B2B software—into an automated SaaS category, unlocking enterprise sales for thousands of startups.",
    logo: "🛡️",
    outcome: "Reached a $1.6B valuation by automating compliance, effectively becoming a tollbooth for B2B startups wanting to sell to the enterprise.",
    year: 2017,
    tags: [
      "B2B",
      "Security",
  ...
  },
  {
    id: "cs-145",
    company: "Zapier",
    title: "Zapier: The Programmatic SEO Masterclass",
    category: "Marketing",
    description: "How Zapier built a $5B automation empire with almost zero paid advertising, leveraging programmatic SEO to capture highly specific, long-tail search intent at scale.",
    logo: "⚡",
    outcome: "Achieved massive profitability and scale entirely through inbound, organic search traffic.",
    year: 2011,
    tags: [
      "SEO",
      "Marketing",
